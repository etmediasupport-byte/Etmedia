...
export function ThreeDMagazineHero({ magazine, onOpenReader, onScrollToEditions }: MagazineHeroProps) {
  ...
  return (
    <section
      ...
      className="relative pt-28 sm:pt-36 pb-16 overflow-hidden bg-gradient-to-b from-slate-950 via-[#0B0F19] to-slate-950 text-white select-none border-b border-slate-800/80"
    >
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,transparent_0%,rgba(7,9,14,0.92)_100%)] pointer-events-none" />
      ...
      <div className="container-x relative z-10 max-w-7xl mx-auto">
        ...
        <div className="grid items-center gap-10 lg:gap-12 lg:grid-cols-12">
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            <div className="inline-flex items-center gap-2 rounded-full border border-cyan-500/30 bg-cyan-500/10 px-4 py-1.5 text-xs font-bold tracking-[0.2em] text-cyan-300 uppercase font-mono shadow-md backdrop-blur-md">
            ...
            <div className="pt-2 flex flex-wrap items-center justify-center lg:justify-start gap-4">
              <button
                ...
                className="group relative inline-flex items-center gap-3 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 px-8 py-4 text-xs sm:text-sm font-extrabold text-white shadow-xl shadow-purple-600/25 hover:shadow-2xl hover:shadow-cyan-500/35 hover:scale-105 active:scale-95 transition-all cursor-pointer font-btn overflow-hidden"
              >
              ...
              <button
                ...
                className="inline-flex items-center gap-2.5 rounded-2xl border border-slate-700 bg-slate-900/80 px-7 py-4 text-xs sm:text-sm font-bold text-slate-200 hover:bg-slate-800 hover:text-white hover:border-cyan-400 transition-all cursor-pointer font-btn shadow-lg backdrop-blur-md"
              >
            ...
            <div className="pt-4 grid grid-cols-2 xs:grid-cols-4 gap-3 text-left">
              <div className="flex items-center gap-2.5 p-2.5 rounded-2xl bg-slate-900/60 border border-slate-800/80 backdrop-blur-sm">
          ...
          <div className="lg:col-span-6 flex items-center justify-center [perspective:2000px]">
            ...
            >
              ...
              <div className="hidden sm:flex flex-col justify-between w-64 lg:w-72 aspect-[1/1.42] bg-slate-100 text-slate-900 p-5 rounded-r-2xl border border-slate-300 shadow-2xl relative overflow-hidden shrink-0">
                {/* Top Label */}
                <div>
                ...
                <div className="my-2 p-3 rounded-xl bg-slate-200/80 border border-slate-300 relative">
                ...
                <div className="pt-2 border-t border-slate-200">
                  ...
                  <div className="flex gap-2">
                    <div className="h-10 w-10 rounded-lg bg-slate-300 overflow-hidden shrink-0">
                      <img
        ...
        {/* BOTTOM HIGHLIGHTS BAR (FLOATING GLASS CARD MATCHING REFERENCE IMAGE) */}
        <div className="mt-14 p-5 sm:p-6 rounded-3xl border border-slate-800/90 bg-slate-900/80 backdrop-blur-xl shadow-2xl">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 items-center">
            
            {/* Col 1: Current Edition */}
            <div className="flex items-center gap-3.5 border-b sm:border-b-0 sm:border-r border-slate-800/80 pb-4 sm:pb-0 sm:pr-4">
              ...
              <div>
                ...
                <h5 className="text-xs sm:text-sm font-extrabold text-white font-display mt-0.5">
            ...
            <div className="flex items-center gap-3.5 border-b sm:border-b-0 lg:border-r border-slate-800/80 pb-4 sm:pb-0 sm:pr-4">
              ...
              <div>
                ...
                <h5 className="text-xs sm:text-sm font-extrabold text-white font-display mt-0.5 truncate max-w-[200px]">
              ...
              <div>
                ...
                {magazine.pdf_url ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="text-xs sm:text-sm font-extrabold text-cyan-400 hover:underline font-display inline-block mt-0.5"
                  >
                    Full Magazine (PDF) →
                  </a>
                ) : (
                  <span className="text-xs sm:text-sm font-extrabold text-slate-300 font-display mt-0.5 block">
                    Full Magazine (PDF)
                  </span>
                )}
              </div>
