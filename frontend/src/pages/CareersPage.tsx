        ...
        <div className="container-x relative z-10">
          <div className="max-w-4xl text-left">
            ...
            <motion.div
              ...
              className="inline-flex items-center gap-2.5 rounded-full border border-purple-500/30 bg-purple-500/10 px-4 py-1.5 text-xs sm:text-sm font-semibold text-purple-300 shadow-lg backdrop-blur-md mb-6"
            >
              <Sparkles className="h-4 w-4 text-purple-400 animate-pulse" />
              <span>ET Media Business Intelligence Careers & Leadership</span>
            </motion.div>
            ...
            >
              Join <span className="bg-gradient-to-r from-purple-400 via-pink-400 to-cyan-400 bg-clip-text text-transparent">ET Media.</span>
            </motion.h1>
            ...
            >
              Build your career at India's premier B2B leadership platform. We are hiring conference producers, sponsorship managers, event strategists, and digital leaders.
            </motion.p>
            ...
            >
              <a
                href="#open-positions"
                className="group relative inline-flex items-center gap-2 rounded-2xl bg-gradient-to-r from-purple-600 via-indigo-600 to-cyan-500 px-7 py-3.5 text-sm sm:text-base font-bold text-white shadow-xl shadow-purple-500/25 hover:shadow-purple-500/40 hover:scale-[1.02] active:scale-[0.98] transition-all"
              >
            ...
            >
              <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-sm">
                <div className="text-2xl sm:text-3xl font-extrabold text-purple-400 font-display">50+</div>
                <div className="text-xs text-slate-400 font-medium mt-1">Summits / Year</div>
              </div>

              <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-sm">
                <div className="text-2xl sm:text-3xl font-extrabold text-cyan-400 font-display">Hybrid</div>
                <div className="text-xs text-slate-400 font-medium mt-1">Flexible Work Model</div>
              </div>

              <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-sm">
                <div className="text-2xl sm:text-3xl font-extrabold text-emerald-400 font-display">100%</div>
                <div className="text-xs text-slate-400 font-medium mt-1">Merit & Growth Culture</div>
              </div>

              <div className="p-4 rounded-2xl bg-slate-900/40 border border-slate-800/60 backdrop-blur-sm">
                <div className="text-2xl sm:text-3xl font-extrabold text-amber-400 font-display">Fast-Track</div>
                <div className="text-xs text-slate-400 font-medium mt-1">Leadership Path</div>
              </div>
            </motion.div>
          </div>
        </div>
