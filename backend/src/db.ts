...
export async function ensureEventPaymentsTable() {
  ...
  try {
    ...
    const colsToEnsure = [
      ...
      { name: "event_slug", type: "VARCHAR(255)" },
      { name: "registration_fee", type: "DECIMAL(10,2) DEFAULT 4999.00" },
      { name: "currency", type: "VARCHAR(10) DEFAULT 'INR'" },
      { name: "gst_percentage", type: "DECIMAL(5,2) DEFAULT 18.00" },
      { name: "gst_included", type: "TINYINT(1) DEFAULT 0" },
      { name: "platform_fee", type: "DECIMAL(10,2) DEFAULT 0.00" },
      { name: "convenience_fee", type: "DECIMAL(10,2) DEFAULT 0.00" },
      { name: "registration_type_prices", type: "LONGTEXT" },
      { name: "early_bird_enabled", type: "TINYINT(1) DEFAULT 1" },
      { name: "early_bird_price", type: "DECIMAL(10,2) DEFAULT 3999.00" },
      { name: "early_bird_start_date", type: "VARCHAR(100)" },
      { name: "early_bird_end_date", type: "VARCHAR(100)" },
      { name: "special_prices", type: "LONGTEXT" },
      { name: "total_seats", type: "INT DEFAULT 150" },
      { name: "available_seats", type: "INT DEFAULT 120" },
      { name: "reserved_seats", type: "INT DEFAULT 10" },
      { name: "vip_seats", type: "INT DEFAULT 10" },
      { name: "speaker_seats", type: "INT DEFAULT 5" },
      { name: "sponsor_seats", type: "INT DEFAULT 5" },
      { name: "coupons_enabled", type: "TINYINT(1) DEFAULT 1" },
      { name: "coupons", type: "LONGTEXT" },
      { name: "pricing_plans", type: "LONGTEXT" },
      { name: "payment_required", type: "TINYINT(1) DEFAULT 1" },
      { name: "online_payment_enabled", type: "TINYINT(1) DEFAULT 1" },
      { name: "offline_payment_enabled", type: "TINYINT(1) DEFAULT 1" },
      { name: "free_registration_allowed", type: "TINYINT(1) DEFAULT 0" },
      { name: "auto_close_seats_full", type: "TINYINT(1) DEFAULT 1" },
      { name: "registration_open_date", type: "VARCHAR(100)" },
      { name: "registration_close_date", type: "VARCHAR(100)" },
      { name: "event_start_date", type: "VARCHAR(100)" },
      { name: "event_end_date", type: "VARCHAR(100)" },
